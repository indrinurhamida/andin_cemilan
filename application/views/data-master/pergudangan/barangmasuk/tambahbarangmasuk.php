        ...
        <form class="" method="post" action="" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                <div class="col-sm-6 mb-6 mb-sm-4">
                    ...
                    <input type="number" name="id_barangmasuk" class="form-control" id="input_id" aria-describedby="emailHelp" placeholder="Masukan ID" value="" readonly>
            ...
            <div class="col-sm-6 mb-3 mb-sm-0">
                ...
                <a href="<?php echo base_url() . 'index.php/data-master/pergudangan/barangmasuk'; ?>" class="btn btn-danger">Kembali</a>
            </div>
        </form>
    </div>
</div>