      ...
      <li class="nav-item <?php 
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php base_url() ?> barang">Daftar Barang</a>
            <a class="collapse-item" href="<?php base_url() ?> barangdetail">Daftar Detail Barang</a>
            <a class="collapse-item" href="<?php base_url() ?> supplier">Daftar Supplier</a>
            <a class="collapse-item" href="<?php base_url() ?> pegawai">Detail Pegawai</a>
          </div>
        </div>
      </li>
