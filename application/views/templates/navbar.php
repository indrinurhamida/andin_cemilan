  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php base_url() ?> pegawai">Pegawai</a>
             <a class="collapse-item" href="<?php base_url() ?> supplier">Supplier</a>
              <a class="collapse-item" href="<?php base_url() ?> barang">Barang</a>
               <a class="collapse-item" href="<?php base_url() ?> barangdetail">Detail Barang</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item <?php if ($this->uri->segment(1) === "") {
        echo "active"; 
      }else if ($this->uri->segment(1) === "barangmasuk") {
        echo "active"; 
